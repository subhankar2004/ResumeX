  ...
  return (
    ...
    >
      ...
      <div className="container relative mt-16 z-10">
        <h1 className="text-7xl md:text-8xl md:leading-none font-semibold tracking-tighter bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] text-transparent bg-clip-text text-center">
          ResumeX
        </h1>
